...
type User struct {
	...
	HomeDirectory *types.Value `json:"HomeDirectory,omitempty"`
	...
	HomeDirectoryType *types.Value `json:"HomeDirectoryType,omitempty"`
	...
	ServerId *types.Value `json:"ServerId,omitempty"`
