...
type ContactChannel struct {
	...
	ChannelAddress *types.Value `json:"ChannelAddress,omitempty"`
	...
	ChannelType *types.Value `json:"ChannelType,omitempty"`
	...
	DeferActivation *types.Value `json:"DeferActivation,omitempty"`
