...
func (r *LinkAssociation) AWSCloudFormationType() string {
	return "AWS::NetworkManager::LinkAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LinkAssociation) MarshalJSON() ([]byte, error) {
	type Properties LinkAssociation
...
func (r *LinkAssociation) UnmarshalJSON(b []byte) error {
	type Properties LinkAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LinkAssociation(*res.Properties)
	}
