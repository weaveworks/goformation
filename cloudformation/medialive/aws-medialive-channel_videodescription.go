...
type Channel_VideoDescription struct {
	...
	RespondToAfd *types.Value `json:"RespondToAfd,omitempty"`
	...
	ScalingBehavior *types.Value `json:"ScalingBehavior,omitempty"`
	...
	Sharpness *types.Value `json:"Sharpness,omitempty"`
