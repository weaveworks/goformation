...
type PermissionSet struct {
	...
	ManagedPolicies *types.Value `json:"ManagedPolicies,omitempty"`
	...
	RelayStateType *types.Value `json:"RelayStateType,omitempty"`
	...
	SessionDuration *types.Value `json:"SessionDuration,omitempty"`
