...
type Theme struct {
	...
	BaseThemeId *types.Value `json:"BaseThemeId,omitempty"`
	...
	ThemeId *types.Value `json:"ThemeId,omitempty"`
	...
	VersionDescription *types.Value `json:"VersionDescription,omitempty"`
