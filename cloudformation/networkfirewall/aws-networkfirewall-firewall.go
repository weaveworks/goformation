...
type Firewall struct {
	...
	DeleteProtection *types.Value `json:"DeleteProtection,omitempty"`
	...
	FirewallName *types.Value `json:"FirewallName,omitempty"`
	...
	FirewallPolicyArn *types.Value `json:"FirewallPolicyArn,omitempty"`
	...
	FirewallPolicyChangeProtection *types.Value `json:"FirewallPolicyChangeProtection,omitempty"`
	...
	SubnetChangeProtection *types.Value `json:"SubnetChangeProtection,omitempty"`
