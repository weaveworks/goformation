...
type Image struct {
	...
	ImageDescription *types.Value `json:"ImageDescription,omitempty"`
	...
	ImageDisplayName *types.Value `json:"ImageDisplayName,omitempty"`
	...
	ImageRoleArn *types.Value `json:"ImageRoleArn,omitempty"`
