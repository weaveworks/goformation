...
type Endpoint struct {
	...
	RetainAllVariantProperties *types.Value `json:"RetainAllVariantProperties,omitempty"`
	...
	RetainDeploymentConfig *types.Value `json:"RetainDeploymentConfig,omitempty"`
