...
type ModelPackageGroup struct {
	...
	ModelPackageGroupDescription *types.Value `json:"ModelPackageGroupDescription,omitempty"`
	...
	ModelPackageGroupName *types.Value `json:"ModelPackageGroupName,omitempty"`
