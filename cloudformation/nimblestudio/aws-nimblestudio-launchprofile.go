...
type LaunchProfile struct {
	...
	LaunchProfileProtocolVersions *types.Value `json:"LaunchProfileProtocolVersions,omitempty"`
	...
	StudioComponentIds *types.Value `json:"StudioComponentIds,omitempty"`
