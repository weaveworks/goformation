...
type Studio struct {
	...
	AdminRoleArn *types.Value `json:"AdminRoleArn,omitempty"`
	...
	StudioName *types.Value `json:"StudioName,omitempty"`
	...
	UserRoleArn *types.Value `json:"UserRoleArn,omitempty"`
