...
// ServiceActionAssociation AWS CloudFormation Resource (AWS::ServiceCatalog::ServiceActionAssociation)
...
type ServiceActionAssociation struct {
	...
	ProvisioningArtifactId *types.Value `json:"ProvisioningArtifactId,omitempty"`
...
func (r *ServiceActionAssociation) AWSCloudFormationType() string {
	return "AWS::ServiceCatalog::ServiceActionAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ServiceActionAssociation) MarshalJSON() ([]byte, error) {
	type Properties ServiceActionAssociation
...
func (r *ServiceActionAssociation) UnmarshalJSON(b []byte) error {
	type Properties ServiceActionAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ServiceActionAssociation(*res.Properties)
	}
