...
type Route struct {
	...
	ApplicationIdentifier *types.Value `json:"ApplicationIdentifier,omitempty"`
	...
	RouteType *types.Value `json:"RouteType,omitempty"`
	...
	ServiceIdentifier *types.Value `json:"ServiceIdentifier,omitempty"`
