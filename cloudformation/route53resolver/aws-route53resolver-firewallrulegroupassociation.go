...
type FirewallRuleGroupAssociation struct {
	...
	FirewallRuleGroupId *types.Value `json:"FirewallRuleGroupId,omitempty"`

	// MutationProtection AWS CloudFormation Property
	// Required: false
	...
	MutationProtection *types.Value `json:"MutationProtection,omitempty"`
